...
function _testFormat(pattern, flags, value) {
    var regex = util.isRegExp(pattern) ? pattern : new RegExp('^' + pattern + '$', flags);
    return regex.test(value);
}

module.exports = exports = {
    string: function string(value, options) {
        return !options || !util.isDefined(value) || util.isString(value) ? null : options.message || '[var] is not a string';
    },
    number: function number(value, options) {
        return !options || !util.isDefined(value) || util.isNumber(value) ? null : options.message || '[var] is not a number';
    },
    presence: function presence(value, options) {
        ...
        if (options.disallowEmpty && (value === '' || util.isArray(value) && value.length === 0) || !util.isDefined(value)) {
            return options.message || '[var] can\'t be blank';
        }
    },
    inclusion: function inclusion(value, options) {
        return !options || !util.isDefined(value) || (options.within || options || []).indexOf(value) > -1 ? null : options.message || '[var] is not included in the list';
    },
    format: function format(value, options) {
        if (!options || !util.isDefined(value)) {
            return null;
        }
    ...
    array: function array(value, options) {
        return !options || !util.isDefined(value) || util.isArray(value) ? null : options.message || '[var] is not an array';
    },
    date: function date(value, options) {
        return !options || !util.isDefined(value) || util.isDate(value) ? null : options.message || '[var] is not an instance of Date';
    },
    uuid: function uuid(value, options) {
        return !options || !util.isDefined(value) || UUID_REGEX.test(value) ? null : options.message || '[var] is not a UUID';
    },
    bool: function bool(value, options) {
        return !options || !util.isDefined(value) || typeof value === 'boolean' ? null : options.message || '[var] is not boolean';
    },
    email: function email(value, options) {
        return !options || !util.isDefined(value) || EMAIL_REGEX.test(value) ? null : options.message || '[var] is not a valid email';
    },
    url: function url(value, options) {
        return !options || !util.isDefined(value) || URL_REGEX.test(value) ? null : options.message || '[var] is not a valid url';
    },
