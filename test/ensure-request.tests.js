        ...
        const tests = [
            {
                ...
                expected: '[500] a.b is not an object'
            },
            {
                params: {
                    a: {
            ...
            },
            {
                ...
                expected: '[500] a.b can\'t be blank'
            },
            {
                params: {
                    a: null
        ...
        const tests = [
            {
                ...
                expected: '[500] a.b is not an array'
            },
            {
                params: {
                    a: {
        ...
        const tests = [
            {
                ...
                expected: '[500] a is not a string'
            },
            {
                params: {
                    a: {
                ...
                expected: '[500] a.b.c is not a string'
            }
        ];
        ...
        const tests = [
            {
                ...
                expected: '[500] a[0].b is not a string'
            }, {
                params: { a: [{ b: [{ c: 'string' }, { c: 999 }] }] },
                constraints: { a: { each: { b: { each: { c: { string: true } } } } } },
                expected: '[500] a[0].b[1].c is not a string'
            }
        ];
        ...
        const tests = [
            {
                ...
                expected: '[500] a[0].b[1] is not a string'
            }, {
                params: { a: [ 1 ] },
                constraints: { a: { each: { _value: { string: true } } } },
                expected: '[500] a[0] is not a string'
            }
        ];
        ...
        const tests = [
            {
                ...
                params: { someVar: 789 },
                constraints: { someVar: { string: true } },
                expected: '[500] someVar is not a string'
            }, {
                params: { someVar: 789 },
        ...
        const tests = [
            {
                ...
                params: { someVar: null },
                constraints: { someVar: { presence: true } },
                expected: '[500] someVar can\'t be blank'
            }, {
                params: { someVar: undefined },
                constraints: { someVar: { presence: true } },
                expected: '[500] someVar can\'t be blank'
        ...
        const tests = [
            {
                ...
                params: { someVar: 'hello' },
                constraints: { someVar: { email: true } },
                expected: '[500] someVar is not a valid email'
            }, {
                params: { someVar: 789 },
                constraints: { someVar: { email: true } },
                expected: '[500] someVar is not a valid email'
        ...
        const tests = [
            {
                ...
                params: { someVar: 'steve@test.com' },
                constraints: { someVar: { url: true } },
                expected: '[500] someVar is not a valid url'
            }, {
                params: { someVar: 789 },
                constraints: { someVar: { url: true } },
                expected: '[500] someVar is not a valid url'
        ...
        const tests = [
            {
                ...
                params: { someVar: 'steve@test.com' },
                constraints: { someVar: { date: true } },
                expected: '[500] someVar is not an instance of Date'
            }, {
                params: { someVar: 789 },
                constraints: { someVar: { date: true } },
                expected: '[500] someVar is not an instance of Date'
        ...
        const tests = [
            {
                ...
                params: { someVar: 4.12 },
                constraints: { someVar: { numericality: { pattern: /^\d\.\d$/ } } },
                expected: '[500] someVar has wrong format'
            }, {
                params: { someVar: 4 },
                ...
                expected: '[500] someVar is not greater than 4'
            }, {
                params: { someVar: 4 },
                ...
                params: { someVar: 3 },
                constraints: { someVar: { numericality: { greaterThanOrEqualTo: 4 } } },
                expected: '[500] someVar is not greater than or equal to 4'
            }, {
                params: { someVar: 2 },
                ...
                params: { someVar: 3 },
                constraints: { someVar: { numericality: { lessThan: 3 } } },
                expected: '[500] someVar is not less than 3'
            }, {
                params: { someVar: 3 },
                ...
                params: { someVar: 4 },
                constraints: { someVar: { numericality: { lessThanOrEqualTo: 3 } } },
                expected: '[500] someVar is not less than or equal to 3'
            }, {
                params: { someVar: undefined },
                constraints: { someVar: { numericality: { greaterThan: 3 } } },
                expected: null
                ...
                params: { someVar: 4.01 },
                constraints: { someVar: { numericality: { onlyInteger: true } } },
                expected: '[500] someVar is not an integer'
            }, {
                params: { someVar: '4' },
                constraints: { someVar: { numericality: { greaterThan: 3 } } },
                expected: null
        ...
        const tests = [
            {
                ...
                params: { someVar: '' },
                constraints: { someVar: { inclusion: { within: ['a', 'b'] } } },
                expected: '[500] someVar is not included in the list'
            }, {
                params: { someVar: null },
                constraints: { someVar: { inclusion: { within: ['a', 'b'] } } },
                expected: null
        ...
        const tests = [
            {
                ...
                params: { someVar: 'b' },
                constraints: { someVar: { format: { pattern: '\\d' } } },
                expected: '[500] someVar is in wrong format'
            }, {
                params: { someVar: 'b' },
                constraints: { someVar: { format: { pattern: /^\d$/ } } },
                expected: '[500] someVar is in wrong format'
        ...
        const tests = [
            {
                ...
                params: { someVar: 999 },
                constraints: { someVar: { array: true } },
                expected: '[500] someVar is not an array'
            }, {
                params: { someVar: 'foo' },
                constraints: { someVar: { array: true } },
                expected: '[500] someVar is not an array'
        ...
        const tests = [
            {
                ...
                params: { someVar: '' },
                constraints: { someVar: { bool: true } },
                expected: '[500] someVar is not boolean'
            }, {
                params: { someVar: '' },
                constraints: { someVar: { bool: false } },
                expected: null
        ...
        const tests = [
            {
                ...
                expected: '[500] someVar is too short (minimum length is 5)'
            }, {
                params: { someVar: 'four' },
                constraints: { someVar: { length: { maximum: 3 } } },
                expected: '[500] someVar is too long (maximum length is 3)'
            }, {
                params: { someVar: [1,2,3,4] },
                constraints: { someVar: { length: { minimum: 5 } } },
                expected: '[500] someVar is too short (minimum length is 5)'
                ...
                params: { someVar: '1' },
                constraints: { someVar: { length: { exactly: 0 } } },
                expected: '[500] someVar has length that is not exactly 0'
            }, {
                params: { someVar: null },
                constraints: { someVar: { length: { minimum: 4 } } },
                expected: null
        ...
        const tests = [
            {
                ...
                expected: '[500] foo.a dependency error'
            }, {
                params: { foo: { a: 1, b: 2 } },
                constraints: {
                    foo: {
                ...
                expected: '[500] foo.a dependency error: some message'
            }, {
                params: { a: 1, b: 2 },
                constraints: {
                    a: {
        ...
        const tests = [
            {
                ...
                constraints: { someArray: { ordered: (current, next) => next > current } },
                expected: '[500] someArray is not ordered'
            }, {
        ...
        const tests = [
            {
                ...
                params: { someVar: 'foo' },
                constraints: { someVar: { uuid: true } },
                expected: '[500] someVar is not a UUID'
            }, {
                params: { someVar: 'foo' },
        ...
        const tests = [
            {
                ...
                params: { someVar: '3.5' },
                constraints: { someVar: { number: true } },
                expected: '[500] someVar is not a number'
            }, {
                params: { someVar: 'foo' },
                constraints: { someVar: { number: true } },
                expected: '[500] someVar is not a number'
